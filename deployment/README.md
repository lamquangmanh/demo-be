...
# How to setup Docker + Kubenetes on local with Docker Desktop

### 1. Install kubenetes
Open Docker Desktop -> Settings -> Kubenetes -> Choose Enable kubenetes
...
### 6. Test your deployment
Once your application is deployed, you can test it by accessing the internal IP address of your device.